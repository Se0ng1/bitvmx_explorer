...
const loadNetworkFunctions = async (networkId) => {
  if (networkId === 'mainnet') {
    ...
    // Import regtest functions
    const regtest = await import('./networkTransactions/regtest')
    fetchTransactionDataAPI = regtest.fetchTransactionData
    fetchAddressDataAPI = regtest.fetchAddressData
    fetchTransactionURLAPI = regtest.fetchTransactionURL
  } else {
